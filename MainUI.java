...
public class MainUI extends JFrame {
	...
	public MainUI() {
		...
		contentPane.setBackground(new Color(32, 37, 57));
		...
		lblTest.setForeground(new Color(153, 193, 241));
		lblTest.setBounds(12, 27, 249, 17);
		contentPane.add(lblTest);
		
		JLabel lblTemperature = new JLabel("Temperature:");
		lblTemperature.setForeground(new Color(98, 160, 234));
		...
		lblHumidity.setForeground(new Color(98, 160, 234));
		...
		lblAirQuality.setForeground(new Color(98, 160, 234));
		...
		lblWaterQuality.setForeground(new Color(98, 160, 234));
		lblWaterQuality.setBounds(329, 56, 111, 17);
		contentPane.add(lblWaterQuality);
		
		JLabel lblWeather = new JLabel("Weather: ");
		lblWeather.setForeground(new Color(98, 160, 234));
		lblWeather.setBounds(179, 123, 82, 17);
		contentPane.add(lblWeather);
		
		JLabel lblLocation = new JLabel("Location:");
		lblLocation.setForeground(new Color(98, 160, 234));
		lblLocation.setBounds(326, 123, 82, 17);
		contentPane.add(lblLocation);
		
		JPanel panel_2 = new JPanel();
		panel_2.setForeground(new Color(192, 97, 203));
		panel_2.setBorder(new TitledBorder(new MatteBorder(5, 5, 5, 5, (Color) new Color(0, 0, 0)), "Guide:", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(192, 97, 203)));
		panel_2.setBackground(new Color(37, 34, 58));
		panel_2.setBounds(12, 280, 481, 297);
		contentPane.add(panel_2);
		panel_2.setLayout(null);
		
		JTextPane Guide = new JTextPane();
		Guide.setForeground(new Color(240, 97, 145));
		Guide.setBackground(new Color(48, 39, 62));
		Guide.setBounds(12, 23, 233, 262);
		panel_2.add(Guide);
		
		JTextPane guide1 = new JTextPane();
		guide1.setBackground(new Color(37, 34, 58));
		guide1.setForeground(new Color(240, 97, 145));
		guide1.setBounds(257, 23, 212, 262);
		panel_2.add(guide1);
		
		JPanel panel_1 = new JPanel();
		panel_1.setBackground(new Color(38, 34, 58));
		panel_1.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0), 5, true), "Suggestions", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(192, 97, 203)));
		...
		Urgent.setBackground(new Color(37, 34, 58));
		Urgent.setBounds(12, 22, 110, 106);
		panel_1.add(Urgent);
		
		JTextPane Information = new JTextPane();
		Information.setForeground(new Color(192, 97, 203));
		Information.setBackground(new Color(37, 34, 58));
		Information.setBounds(266, 22, 161, 106);
		panel_1.add(Information);
		
		JTextPane Humiditytab = new JTextPane();
		Humiditytab.setForeground(new Color(248, 228, 92));
		Humiditytab.setBackground(new Color(37, 34, 58));
		Humiditytab.setBounds(133, 22, 121, 54);
		panel_1.add(Humiditytab);
		
		JTextPane WPollution = new JTextPane();
		WPollution.setForeground(new Color(53, 132, 228));
		WPollution.setBackground(new Color(37, 34, 58));
		...
		APollution.setBackground(new Color(37, 34, 58));
		...
		Disaster.setBackground(new Color(37, 34, 58));
		Disaster.setBounds(133, 85, 121, 39);
